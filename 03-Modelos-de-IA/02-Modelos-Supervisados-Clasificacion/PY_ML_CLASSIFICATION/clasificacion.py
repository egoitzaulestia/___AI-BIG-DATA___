...
#os.chdir(r"E:/dias 2-3 diciembre/17-Modelos/Modelos_Clasificacion")
...
RegLog.coef_ # Esto es como el sumary de la regresión logística de R
...
# f1 = f1_score(y_true, y_pred) # Corregir las variables si queiro medir el F1 score
# print("F1 Score:", f1)
...
confusion_matrix(test_data_y, prediccion)
#tn, fp, fn, tp
confusion_matrix(test_data_y, prediccion).ravel()
...
prediccion
# Calculamos  nivel de acierto en train y en test
...
#os.environ["PATH"] += os.pathsep + 'C:/Users/Alejandro/anaconda3/Lib/site-packages/graphviz/'
#descargar Graphviz de google: https://graphviz.org/download/
#y escribir el path en el que se descarga:
...
import graphviz
os.environ["PATH"] += os.pathsep + 'C:/Users/Alejandro/Anaconda3/Library/bin/graphviz/'
