...
class Objeto():
    ...
    def alquilar_objeto(self):
        if self.__disponibilidad and self.__copias:
            ...
            print(f"No puedes alquilar este/a {self.__class__.__name__}")
    ...
    def devolver_objeto(self, estado):
        ...
        elif tiempo_transcurrido > datetime.timedelta(seconds=10):
...
objeto_1.comprar(2, 10)
objeto_1.alquilar_objeto()
objeto_1.devolver_objeto(True)
objeto_1.balance



objeto_1.verificar_disponibilidad()
objeto_1.fichar()
