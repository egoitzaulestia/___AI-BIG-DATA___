...
# Ejercicios de v.a. continua
# 
# Introducción a la estadística 
# 
# Más ejercicios: Herramientas: Definimos una función a trozos y su gráfica en R usando: function(x), 
# Vectorize(), plot() También puede ser de ayuda para el cálculo de integrales definidas: integrate(). 
# Esto se puede encontrar en plotear funciones.R
...
# a) Verificar las propiedades de densidad y graficar
...
# b) Probabilidades sin cálculo formal
...
# c) Probabilidad P(0.4 ≤ X ≤ 0.7) 

# Vamos a calcular esta probabilidad gráficamente y luego formalmente usando la integral.

# 1. Gráficamente 
# Resaltamos el área bajo la curva entre x=0.4 y x=0.7:
...
# 2. Cálculo formal Calcula la integral entre 0.4 y 0.7:
...
# Dada la variable aleatoria X con la siguiente función de densidad:
...
# Dada la siguiente funcióon de densidad:
...
# Un trabajador puede llegar a su trabajo en cualquier momento entre las 6 y las 7 de la mañana 
# con la misma probabilidad. Considerando a X: ”hora de llegada”, se pide:
...
# Para resolver este problema, asumimos que el dial genera números aleatorios de manera uniforme 
# en el rango [ 0 , 360 ) [0,360) (un círculo completo).
...
# Sea X una v.a. continua con la siguiente función de densidad:
...
# Dada la siguiente función de densidad de X:
...
# Teniendo la siguiente función de densidad:
# Calcular su esperanza, E(X) y su varianza, Var(X)
